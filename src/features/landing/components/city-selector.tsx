...
export function CitySelector() {
  ...
  const hiddenRegionalCenters = new Set(["Донецьк", "Луганськ"]);
  const visibleCities = cities.filter((city) => !hiddenRegionalCenters.has(city.city) && !hiddenRegionalCenters.has(city.regionalCenter));
