...
const WHY_US_ITEMS = [
  ...
  },
  {
    ...
    body: "Кожен запис підтверджуєш одним дотиком у Telegram. Для нових чи ненадійних клієнток система підкаже попросити передоплату — постійні записуються без бар'єрів.",
  },
] as const;
